...
function Home() {
  return (
    <>
      <div className="w-screen h-screen text-black justify-center flex flex-col font-bold text-2xl ">
        <div className="w-full h-[10%] flex justify-around items-end ">
          <Catagery />
        </div>
          ...
          <div className="w-[50%] h-full flex flex-col justify-center items-center">
            <motion.div className="flex flex-col gap-2">
              <motion.h1
                ...
                className="text-2xl font-semibold py-5 robotFont"
              >
                Neew Arrives Only
              </motion.h1>
              <motion.p
                ...
                className="xl:text-7xl md:text-6xl flex uppercase justify-start items-center gap-5 neueFont font-bold"
              >
                New <img src={hand} alt="" className="w-20" />
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: -50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.7 }}
                className="xl:text-7xl md:text-6xl text-7xl uppercase neueFont "
              >
                Collection
              </motion.p>
              <motion.p
        ...
        <div className="w-[90%] h-[50%] bg-[#020202fd] flex  rounded-4xl text-white">
          <div className="w-[50%] h-full flex flex-col justify-center items-center">
            <div className=" h-full flex flex-col justify-center items-start gap-5">
              <h1 className="text-7xl robotFont font-bold">Excusive</h1>
              <h1 className="text-7xl robotFont font-bold">Offer For You</h1>
      ...
      <div className="w-screen h-[50vh] overflow-hidden flex bg-black justify-center items-end">
        <Footer />
      </div>
    </>
  );
